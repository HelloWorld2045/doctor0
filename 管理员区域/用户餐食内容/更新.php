...
$query_DetailRS1 = "SELECT * FROM 用户餐食内容  WHERE id = $recordID";
...
<table border="1" align="center">
  ...
  <tr>
    <td>餐食内容</td>
    <td><?php echo $row_DetailRS1['餐食内容']; ?> </td>
  </tr>
  <tr>
    <td>卡路里估计</td>
    <td><?php echo $row_DetailRS1['卡路里估计']; ?> </td>
  </tr>
  <tr>
    <td>条形码</td>
    <td><?php echo $row_DetailRS1['条形码']; ?> </td>
  </tr>
  <tr>
    <td>用户餐食id</td>
    <td><?php echo $row_DetailRS1['用户餐食id']; ?> </td>
  </tr>
  <tr>
    <td>创建时间</td>
