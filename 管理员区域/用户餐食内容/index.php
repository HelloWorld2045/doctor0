...
$query_Recordset1 = "SELECT * FROM 用户餐食内容 WHERE 是否删除 = 0 ORDER BY id DESC";
...
<table width="100%" border="1" align="center">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_Recordset1['餐食内容']; ?>&nbsp; </td>
      <td><?php echo $row_Recordset1['卡路里估计']; ?>&nbsp; </td>
      <td><?php echo $row_Recordset1['条形码']; ?>&nbsp; </td>
      <td><?php echo $row_Recordset1['用户餐食id']; ?>&nbsp; </td>
