...
$query_Recordset1 = "SELECT * FROM 用户诊断 WHERE 是否删除 = 0 ORDER BY id DESC";
  ...
  <table border="1" align="center">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><?php echo $row_Recordset1['症状id列表']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['体征id列表']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['诊断疾病id列表']; ?>&nbsp; </td>
