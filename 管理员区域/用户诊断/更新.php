...
$query_DetailRS1 = "SELECT * FROM 用户诊断  WHERE id = $recordID";
...
<table border="1" align="center">
  ...
  <tr>
    <td>症状id列表</td>
    <td><?php echo $row_DetailRS1['症状id列表']; ?> </td>
  </tr>
  <tr>
    <td>体征id列表</td>
    <td><?php echo $row_DetailRS1['体征id列表']; ?> </td>
  </tr>
  <tr>
    <td>诊断疾病id列表</td>
    <td><?php echo $row_DetailRS1['诊断疾病id列表']; ?> </td>
  </tr>
  <tr>
    <td>创建时间</td>
