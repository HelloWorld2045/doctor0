...
$query_Recordset1 = "SELECT * FROM 用户信息 WHERE 是否删除 = 0 ORDER BY id DESC";
  ...
  <table width="100%" border="1" align="center">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><?php echo $row_Recordset1['用户生日']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['身高']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['体重']; ?>&nbsp; </td>
