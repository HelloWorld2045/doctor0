<?php if ($totalRows_Recordset1 == 0) { // Show if recordset empty ?><?php require_once('../../Connections/localhost.php'); ?>
...
$query_Recordset1 = "SELECT * FROM 权限 WHERE id = 0 ORDER BY id DESC";
