...
$query_Recordset1 = "SELECT * FROM 预约 WHERE 已经删除 = 0 ORDER BY id DESC";
  ...
  <table width="100%" border="1" align="center">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><?php echo $row_Recordset1['医院id']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['科室id']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['医生id']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['操作员id']; ?>&nbsp; </td>
        <td><?php echo $row_Recordset1['预约时间']; ?>&nbsp; </td>
